...
function createDocumentRow(documentName, uniqueId, isDuplicate = false, originalName = null) {
    ...
    addLineButton.style.backgroundColor = 'rgb(135 164 237)';
    ...
    addLineButton.addEventListener('mouseover', function () {
        addLineButton.style.backgroundColor = 'rgb(50 77 145)'; // لون الخلفية عند التمرير
    });

    addLineButton.addEventListener('mouseout', function () {
        addLineButton.style.backgroundColor = 'rgb(135, 164, 237)'; // اللون الأصلي
    });
    ...
    uploadButton.style.backgroundColor = isUploadAllowed ? '#a3b6e5' : '#ccc';
    ...
    downloadButton.addEventListener('mouseover', function () {
        downloadButton.style.backgroundColor = 'rgb(50 77 145)'; // تغيير لون الخلفية عند التمرير
        downloadButton.style.color = 'white'; // تغيير لون النص عند التمرير
        downloadButton.style.boxShadow = '0px 4px 6px rgba(0, 0, 0, 0.2)'; // إضافة ظل
    });

    downloadButton.addEventListener('mouseout', function () {
        downloadButton.style.backgroundColor = '#a3b6e5'; // اللون الأصلي
        downloadButton.style.color = 'black'; // اللون الأصلي للنص
...
function createExpiryDateModal(docName, currentExpiryDate, onConfirm) {
    ...
    docNameElem.style.backgroundColor = 'rgb(163, 182, 229)';
    ...
    confirmButton.style.backgroundColor = '#7692d7';
    ...
    confirmButton.addEventListener('mouseover', function () {
        confirmButton.style.backgroundColor = 'rgb(50 77 145)'; // تغيير لون الخلفية عند التمرير
    ...
    confirmButton.addEventListener('mouseout', function () {
        ...
        confirmButton.style.color = '#000'; // اللون الأصلي للنص
...
async function sendEditedExpiryDate(docName, editedDate) {
    const editApiUrl = 'https://7vj4phsced.execute-api.us-east-1.amazonaws.com/PROD/MFCDUF'; // تأكد من صحة الرابط
...
async function uploadDocument(file, docName, row) {
    const uploadApiUrl = 'https://7vj4phsced.execute-api.us-east-1.amazonaws.com/PROD/MFCDUF';  // استبدل بالرابط الفعلي لـ Lambda
...
async function deleteDocument(docName) {
    const deleteApiUrl = 'https://7vj4phsced.execute-api.us-east-1.amazonaws.com/PROD/MFCDUF';
...
async function fetchDocumentStatuses() {
    const fetchApiUrl = 'https://7vj4phsced.execute-api.us-east-1.amazonaws.com/PROD/MFCDUF';
