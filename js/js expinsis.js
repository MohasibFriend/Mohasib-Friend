...
function createUploadElements() {
    ...
    fileInputContainer.style.backgroundColor = '#5f85d4';
    ...
    emptybtn.style.backgroundColor = '#5f85d4';
...
function showSuccessModal() {
    ...
    messagePara.innerHTML = ".تم حفظ مصروفاتك بنجاح<br>لكي يصلك الإقرار بدقة عالية، الرجاء الانتظار لمدة 24 ساعة فقط<br>!شكرًا لاستخدامك محاسب فريند";
